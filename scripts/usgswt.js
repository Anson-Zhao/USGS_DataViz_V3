                    ...
                    success: function (resp) {
                        if (!resp.error) {
                            ...
                            for (var i = 0; i < resp.data.length; i++) {
                                ...
                                data[i] = new WorldWind.MeasuredLocation(resp.data[i].ylat, resp.data[i].xlong, 0.05);
                                ...
                                if (i === resp.data.length - 1) {
                                    ...
                                    HeatMapLayer.scale = ['#000000', '#ffffff', '#00ff00', '#ffff00', '#ff0000'];
                                    // HeatMapLayer._incrementPerIntensity = 0.2;
